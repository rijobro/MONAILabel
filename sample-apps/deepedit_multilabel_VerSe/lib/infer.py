...
from .transforms import VarSpacingd
...
class DeepEditSeg(InferTask):
    ...
    def pre_transforms(self):
        return [
            LoadImaged("image"),
            AddChanneld("image"),
            CropForegroundd("image", "image"),
            VarSpacingd("image", mode="bilinear"),
            ScaleIntensityd("image"),
            Orientationd("image", axcodes="IAR"),
    ...
    def post_transforms(self):
        return [
            ToTensord(keys="pred", device="cpu"),
