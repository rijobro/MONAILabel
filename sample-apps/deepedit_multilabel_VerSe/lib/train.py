...
from .transforms import VarSpacingd, AddInitialSeedPointMissingLabelsd, FindAllValidSlicesMissingLabelsd
...
class MyTrain(BasicTrainTask):
    ...
    def train_pre_transforms(self, context: Context):
        ...
        return [
            ...
            VarSpacingd(keys, mode=["bilinear", "nearest"]),
            ScaleIntensityd("image"),
            Orientationd(keys, axcodes="IAR"),
