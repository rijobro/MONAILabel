...
class MyApp(MONAILabelApp):
    def __init__(self, app_dir, studies, conf):
        ...
        self.label_names = {f"Ver: {i}": i for i in range(1, 29)}
        self.label_names["background"] = 0
        ...
        logger.info(f"Working with Network {network}")
        ...
        super().__init__(
            ...
            studies=studies,
            conf=conf,
            name="DeepEdit - Multilabel (VerSe)",
            description="Active learning solution using DeepEdit to label 3D Images using the VerSe dataset",
        )
